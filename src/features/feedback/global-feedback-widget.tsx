        ...
        {open ? (
          ...
          >
            <motion.section
              ...
              className="max-h-[92dvh] w-full overflow-y-auto rounded-t-[28px] bg-[#fffdf8] p-5 shadow-2xl sm:max-w-2xl sm:rounded-[28px] sm:p-6"
            ...
            >
              ...
              >
                ...
                <div className="sticky bottom-0 -mx-5 flex flex-col-reverse gap-3 border-t border-[#eadfc9] bg-[#fffdf8]/95 px-5 pt-4 pb-1 backdrop-blur sm:-mx-6 sm:flex-row sm:justify-end sm:px-6">
                  <button
                    type="button"
                    disabled={mutation.isPending}
                    onClick={closeDialog}

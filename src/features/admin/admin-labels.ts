...
export const auditActionLabels: Record<string, string> = {
  ...
  ADMIN_PASSWORD_RESET_REQUESTED: "Gửi liên kết đặt lại mật khẩu",
  ADMIN_TEMP_PASSWORD_SET: "Đặt mật khẩu tạm thời",
  ADMIN_PARENT_PIN_CLEARED: "Xóa mã PIN phụ huynh",
  ADMIN_PARENT_PIN_RESET: "Đặt mã PIN phụ huynh tạm thời",

...
export function getCachedMissionMap(child: { id: string; ageGroup: AgeGroup }) {
  return unstable_cache(() => getMissionMap(child), ["child-mission-map", child.id, child.ageGroup], {

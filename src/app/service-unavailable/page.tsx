  ...
  return (
    <main className="paper-texture grid min-h-screen place-items-center px-5 py-10">
      <Card className="max-w-lg p-8 text-center">
        <DatabaseZap className="mx-auto text-[#d95812]" size={48} />
        <h1 className="mt-4 text-3xl font-black">Dữ liệu đang tạm nghỉ</h1>
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          <a href="" className="rounded-2xl bg-[#e9641a] px-5 py-3 font-black text-white">
            Thử kết nối lại
          </a>

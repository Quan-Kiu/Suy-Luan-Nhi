...
| Role escalation                 | Server-side RBAC on every admin route and API; role changes are audited                     |
| Banned account reuse            | Sessions revoked on ban; new session creation rejects banned users                          |
